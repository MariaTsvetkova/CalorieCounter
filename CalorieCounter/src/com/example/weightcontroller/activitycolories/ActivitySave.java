...
import com.example.weightcontroller.ActivityDiary.SportActivity;
...
public class ActivitySave extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sportActivity = (SportActivity) getIntent().getSerializableExtra(
				"sportactivity");
		...
		final int calorieBurnt = getWeightRang();
		...
		btn_ok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				SampleDBAdapter bdHelper = new SampleDBAdapter(
						getApplicationContext());
				boolean added = bdHelper.addActivityDetails(calories);
				if (!added) {
	...
	public void showMessageBox() {
		...
		builder.setTitle("Message").setMessage("Your activity was added")
